...
export function JuliaCanvas() {
  const canvasRef = useRef<HTMLCanvasElement>(null)
  const { iterations, colorScheme, zoom, setZoom, offsetX, setOffsetX, offsetY, setOffsetY, resetView, juliaConstant } =
    useFractalStore()
  ...
  }, [iterations, colorScheme, zoom, offsetX, offsetY, juliaConstant, canvasSize])
